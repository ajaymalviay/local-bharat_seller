final String appName = 'Local Bharat Seller';

final String packageName = 'com.localBharat.seller';

final String iosPackage = 'com.localBharat.seller';
...
final String baseUrl = 'https://developmentalphawizz.com/local_bharat/seller/app/v1/api/';
